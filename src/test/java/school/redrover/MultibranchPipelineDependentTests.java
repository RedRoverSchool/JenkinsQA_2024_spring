...
public class MultibranchPipelineDependentTests extends BaseTest {
    ...
    private final String newMultiPipelineName = "newMultibranchPipeline";

    @Test
    public void testCreate() {
        getDriver().findElement(By.xpath("//a[@href='newJob']")).click();
        getDriver().findElement(By.xpath("//input[@class='jenkins-input']"))
            .sendKeys(multiPipelineName);
        ...
        Assert.assertEquals(actualMultibranchPipelineName.getText(), multiPipelineName);
